                ...
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="card-body p-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6">
                                <label class="form-label text-muted">Credit</label>
                                <div class="fw-semibold">${{ number_format(optional($user)->credit, 2) ?? 'N/A' }}</div>
                            </div>
                            @endif
                            @unless(optional($user)->hasRole('Customer'))
                            <div class="col-sm-6">
                                <label class="form-label text-muted">Roles</label>
                                <div class="fw-semibold">
                                    @forelse(optional($user)->roles as $role)
            ...
            <div class="modal-dialog modal-dialog-centered">
                <form action="{{ route('profile.update') }}" method="POST"
                    ...
                    <div class="modal-header bg-primary text-white rounded-top-4">
                        <h5 class="modal-title" id="editProfileModalLabel"><i class="bi bi-pencil-fill me-2"></i>Edit
                            Profile</h5>

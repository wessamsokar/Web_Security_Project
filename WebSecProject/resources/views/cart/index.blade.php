    ...
    <div class="row g-4">
                ...
                @forelse ($purchases as $item)
                    <div class="cart-item" style="border-bottom: 1px solid #eee; margin-bottom: 15px; padding-bottom: 15px;">
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <img src="{{ $item->product->image ?? asset('images/default.png') }}" 
                            ...
                            <div class="col-md-3 text-end">
                                <p class="mb-1 fw-bold">${{ number_format($item->quantity * $item->price, 2) }}</p>
        ...
        <div class="col-lg-4">
            <div class="summary-card">
                ...
                @php
                    $total = $purchases->sum(fn($item) => $item->quantity * $item->price);
                @endphp

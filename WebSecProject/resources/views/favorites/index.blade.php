            ...
            <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted">${{ number_format($fav->product->price, 2) }}</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ route('products.show', $fav->product->id) }}" class="btn btn-primary btn-sm">View</a>

                                    <form action="{{ route('favorites.destroy', $fav->product->id) }}" method="POST" onsubmit="return confirm('Remove from favorites?')">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-outline-danger btn-sm" title="Remove from favorites">
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        ...
                        <p class="text-muted">Add items to your favorites and they’ll appear here.</p>

        ...
        <div class="right">
            <div class="login-container page-transition" :class="{ 'leaving': leaving }">
                ...
                <div class="social-buttons">
                    <a href="{{ route('login_with_google') }}" class="social-button google">
                    ...
                    <a href="{{ route('login_with_facebook') }}" class="social-button facebook">
                        <i class="bi bi-facebook"></i>
                    </a>

                    <a href="{{ route('login_with_github') }}" class="social-button github">
                        <i class="bi bi-github"></i>
                    </a>

                    <a href="{{ route('login_with_linkedin') }}" class="social-button linkedin">
                        <i class="bi bi-linkedin"></i>
                    </a>
                    <form method="POST" action="{{ route('login.certificate') }}" style="display:inline;">
                        @csrf
                        <button type="submit" class="social-button certificate">
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('forgot_password') }}" class="text-decoration-none text-muted">Forget Password?</a>
                </div>
            </div>
        </div>
    </div>
